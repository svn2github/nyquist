...
;; Usage (SAL syntax):
;; 
;;     sf-granulate(filename, grain-dur, grain-dev, ioi, ioi-dev, 
;;                  pitch-dev, [file-start], [file-end])
;;         see the function definition below for a description
;;     gran-test() - set *granfile* and then call this for a demo
;;
;; DOCUMENTATION
;;

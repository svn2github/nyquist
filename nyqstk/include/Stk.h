...
#if STK_NYQUIST
  // for Nyquist, the current directory can change, so when the
  // program initializes, it will put the raw wave path into the
  // global string rawwave_path.
  extern const char *rawwave_path;
